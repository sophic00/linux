...
| P-001 | drivers/misc/open-dice.c | 1 | porter-P-001 (subagent) | porting | — | — | pilot port: platform+miscdevice+mutex+mmap; branch rw/P-001-open-dice; pilot porter subagent spawned (same model as orchestrator); worktree /tmp/rw-wt/rw-p001-open-dice; spec-first workflow |
| P-002 | drivers/misc/dummy-irq.c | 2 | porter-P-002 (subagent) | porting | — | — | tiny IRQ-handler module; exercises irq abstraction |
...
| P-005 | drivers/char/hangcheck-timer.c | 2 | porter-P-005 (subagent) | porting | — | — | timer + module params, no userspace ABI |
